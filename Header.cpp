...
template<typename key, typename data>
typename RBTree<key,data>::List RBTree<key, data>::get_keys()
{
	Queue queue; List key_list;
	Node* current = root;
	queue.push(current);
	while (queue.empty())
	{
...
template<typename key, typename data>
typename RBTree<key,data>::List2 RBTree<key, data>::get_values()
{
	Queue queue; List2 data_list;
	Node* current = root;
	queue.push(current);
	while (queue.empty())
	{
 ...
 RBTree<key, data>::List::List()
{
 ...
 template<typename key, typename data>
 void RBTree<key, data>::List::reset_list()
 {
	 head = nullptr;
	 tail = nullptr;
 }
 ...
 template<typename key, typename data>
 void RBTree<key, data>::List::push_back(key key)
 {
	 if (size == 0)//We add the new element first.
	 {
		 head = new keys(key);
 ...
 template<typename key, typename data>
 void RBTree<key, data>::List2::reset_list()
 {
	 head = nullptr;
	 tail = nullptr;
 }
 ...
 template<typename key, typename data>
 void RBTree<key, data>::List2::push_back(data newdata)
 {

	 if (size == 0)//We add the new element first.
	 {
		 head = new value(newdata);
		 tail = head;
	 }
	 else//We add the new element last.
	 {
		 value* current = new value(newdata);
		 tail->next = current;
		 tail = current;
	 }
	 size++;
